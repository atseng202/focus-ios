...
class PhotonActionSheet: UIViewController, UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate {
    ...
    private var tintColor = UIConstants.Photon.Grey80
    ...
    lazy var closeButton: UIButton = {
        ...
        button.backgroundColor = UIConstants.Photon.Grey10
        button.setTitleColor(UIColor.blue, for: .normal)
        button.layer.cornerRadius = PhotonActionSheetUX.CornerRadius
        button.titleLabel?.font = UIConstants.fonts.firstRunTitle
...
//                                                    blurType: BOXFILTER,
//                                                    tintColor: UIConstants.black.withAlphaComponent(0.2),
...
private class PhotonActionSheetSiteHeaderView: UITableViewHeaderFooterView {
    ...
    lazy var descriptionLabel: UILabel = {
        let titleLabel = UILabel()
        titleLabel.font = UIConstants.fonts.aboutText
        titleLabel.textAlignment = .left
        titleLabel.numberOfLines = 1
        return titleLabel
    }()
...
private class PhotonActionSheetSeparator: UITableViewHeaderFooterView {
    ...
    override init(reuseIdentifier: String?) {
        ...
        self.backgroundView = UIView()
        self.backgroundView?.backgroundColor = .clear
        separatorLineView.backgroundColor = UIConstants.Photon.Grey40
...
private class PhotonActionSheetCell: UITableViewCell {
    ...
    func configure(with action: PhotonActionSheetItem) {
        ...
        titleLabel.font  = action.bold ? UIConstants.fonts.aboutText : UIConstants.fonts.aboutText
...
//            statusIcon.setImage(with: action.iconURL, placeholderImage: image, options: []) { (img, err, _, _) in
//                if let img = img {
...
//            }
            ...
            if action.iconURL == nil {
                ...
                self.statusIcon.image = self.statusIcon.image?.createScaled(size: PhotonActionSheetUX.IconSize)
            }
        ...
        case .Text:
            disclosureLabel.font = action.bold ? UIConstants.fonts.aboutText : UIConstants.fonts.aboutText
